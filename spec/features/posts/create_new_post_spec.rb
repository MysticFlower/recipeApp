...
RSpec.feature "Create a new recipe", :type => :feature do
  ...
  include_examples 'user creates a new post', 'vegetarian'
  include_examples 'user creates a new post', 'non_vegetarian'
  include_examples 'user creates a new post', 'vegan'
end